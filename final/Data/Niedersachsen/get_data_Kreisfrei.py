...
cities = ["Braunschweig", "Delmenhorst", "Emden", "Oldenburg", "Osnabrück", "Salzgitter", "Wilhelmshaven", "Wolfsburg"]

# Path to the XML file
xml_file = 'Kreisfrei_2016.xml'
...
with open('Niedersachsen2016_Kreisfrei.csv', mode='w', newline='', encoding='utf-8') as file:
        ...
        for row in table.findall('ss:Row', namespaces):
            ...
            for idx, cell in enumerate(row.findall('ss:Cell', namespaces)):
                ...
                if data is not None and data.text:  # Check if there's actual data
                    ...
                    if "Braunschweig" not in cell_value and j == 0:
                        i = -1
                        #print(cell_data)
                        continue
                    else:
