...
# Webseite laden
basic_url = "http://alt.wahlergebnisse.nrw.de/kommunalwahlen/2004/stadtraete_kreisraete/"  # Statistisches Landesamt BW
...
for i in number_gemeinde:
    try:
        url = basic_url + f"a{i}000kw0400.htm"
        driver.get(url)
        ...
        summ = int(driver.find_element(By.XPATH, "/html/body/div/div[4]/div[2]/div[3]/table/tbody/tr[4]/td[4]").text)
...
with open("NRW2004_Kreisfrei.csv", mode="w", newline="", encoding="utf-8") as outfile:
