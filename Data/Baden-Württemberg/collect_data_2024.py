...
covered_cities = []
error_file_path = ".\Data Literacy\Baden-Württemberg\errors_collecting.txt"
...
# Webseite laden
url = "https://www.statistik-bw.de/SRDB/?H=Wahlen&U=Kommunal&T=02045000&E=GS"  # Statistisches Landesamt BW
driver.get(url)
...
for landkreis in range(2,46): # 46
    try:
            ...
            try:
                ...
                if city in cities_over_20k:
                    try:
                        ...
                        driver.find_element(By.XPATH, '//*[@id="Auswahl-GS"]/option[2]').click() # 'gewählte Mitglieder'
                        driver.find_element(By.XPATH, '//*[@id="asset-MG"]/ul/li/a').click()  # download csv - file
...
print("covered cities are:")
print(covered_cities)
print(f"number of covered cities is: {len(covered_cities)} and missing are: {len(cities_over_20k)-len(covered_cities)}")
print("missing cities are:")

for key, value in cities_over_20k.items():
