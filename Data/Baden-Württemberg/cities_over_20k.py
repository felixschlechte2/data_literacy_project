...
# Webseite laden
url = "https://de.wikipedia.org/wiki/Liste_der_gr%C3%B6%C3%9Ften_St%C3%A4dte_in_Baden-W%C3%BCrttemberg"  # Stand 31.12.2023
driver.get(url)
...
for rank in range(1,109):
    try:
        stadt = driver.find_element(By.XPATH, f'//*[@id="mw-content-text"]/div[1]/table/tbody/tr[{rank}]/td[2]')
