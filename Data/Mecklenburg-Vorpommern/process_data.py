...
# 2024
data = pd.read_csv('k_gemeinden_2024.csv', sep=';', decimal=",")
...
# 2019
data = pd.read_csv('kw2019k_gemeinden.csv', sep=';', decimal=",")
data = data[data['Gemeindename'].str.contains(combined_cities)]
data = data.loc[:, ['Gemeindename'] + parties]
data = data.loc[1::2]
...
data = pd.read_csv('K_Gemeinden_2014.csv', sep=';', decimal=",")
data = data[data['Gemeindename'].str.contains(combined_cities)]
data = data.loc[:, ['Gemeindename'] + parties]
data = data.loc[1::2]
...
# 2011
data = pd.read_csv('K_Gemeinden_2011.csv', sep=';', decimal=",")
data = data[data['Gemeindename'].str.contains(combined_cities)]
data['AfD'] = 0
data = data.loc[:, ['Gemeindename'] + parties]
data = data.loc[1::2]
...
data = pd.read_csv('KW 2004 Gemeinden.csv', sep=';', decimal=",")
data = data[data['Gemeindename'].str.contains(combined_cities)]
data['AfD'] = 0
data = data.loc[:, ['Gemeindename'] + parties]
data = data.loc[1::2]
...
data = pd.read_csv('B734G 1999 01.csv')
data = data[data['Gemeindename'].str.contains(combined_cities)]
data['AfD'] = 0
...
data = pd.read_csv('B734G 1994 01.csv')
data = data[data['Gemeindename'].str.contains(combined_cities)]
data['AfD'] = 0
data = data.loc[:, ['Gemeindename'] + parties_plus]
data[parties_plus] = data[parties_plus].apply(pd.to_numeric, errors='coerce')
